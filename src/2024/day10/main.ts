...
export const testsPart1 = [
  ...
  { input: getInput(`src/${year}/${day}/test4.txt`), result: 3 },
  { input: getInput(`src/${year}/${day}/test5.txt`), result: 36 },
];

export const testsPart2 = [
  { input: getInput(`src/${year}/${day}/test6.txt`), result: 3 },
  { input: getInput(`src/${year}/${day}/test3.txt`), result: 13 },
  { input: getInput(`src/${year}/${day}/test7.txt`), result: 227 },
  { input: getInput(`src/${year}/${day}/test5.txt`), result: 81 },
];
