...
export const testsPart1 = [
  // { input: getInput(`src/${year}/${day}/test.txt`), result: 140 },
  // { input: getInput(`src/${year}/${day}/test2.txt`), result: 772 },
  // { input: getInput(`src/${year}/${day}/test3.txt`), result: 1930 },
];

export const testsPart2 = [
  { input: getInput(`src/${year}/${day}/test.txt`), result: 80 },
  { input: getInput(`src/${year}/${day}/test2.txt`), result: 436 },
  { input: getInput(`src/${year}/${day}/test3.txt`), result: 1206 },
  { input: getInput(`src/${year}/${day}/test4.txt`), result: 236 },
  { input: getInput(`src/${year}/${day}/test5.txt`), result: 368 },
];
