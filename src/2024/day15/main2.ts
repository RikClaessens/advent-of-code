...
export const testsPart1 = [
  // { input: getInputAsString(`src/${year}/${day}/test.txt`), result: 10092 },
  // { input: getInputAsString(`src/${year}/${day}/test2.txt`), result: 2028 },
];

export const testsPart2 = [
  // { input: getInputAsString(`src/${year}/${day}/test3.txt`), result: 0 },
  // { input: getInputAsString(`src/${year}/${day}/test.txt`), result: 9021 },
];

export const input = getInputAsString(`src/${year}/${day}/test.txt`);
