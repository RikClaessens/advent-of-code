...
export const testsPart1 = [
  { input: getInput(`src/${year}/${day}/test.txt`), result: 7036 },
  { input: getInput(`src/${year}/${day}/test2.txt`), result: 11048 },
];

export const testsPart2 = [
  { input: getInput(`src/${year}/${day}/test.txt`), result: 45 },
  { input: getInput(`src/${year}/${day}/test2.txt`), result: 64 },
];
