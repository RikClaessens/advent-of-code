...
export const testsPart1 = [
  ...
  { input: getInput(`src/${year}/${day}/test2.txt`), result: '' },
  { input: getInput(`src/${year}/${day}/test3.txt`), result: '0,1,2' },
  {
    input: getInput(`src/${year}/${day}/test4.txt`),
    result: '4,2,5,6,7,7,7,7,3,1,0',
  },
  { input: getInput(`src/${year}/${day}/test5.txt`), result: '' },
  { input: getInput(`src/${year}/${day}/test6.txt`), result: '' },
];
...
export const testsPart2 = [
  { input: getInput(`src/${year}/${day}/test7.txt`), result: 117440n },
];
